...
close all
tp = [7, 14, 21];
plot_SIR(X_SIR, X0_ad_SIR, N, p_SIR, dates, t0, tf, tp, "./results/october/Sardegna/SIR_fitting.png");
%% FITTING SEIR MODEL
% [S, E, I, R]
...
close all
tp = [7,14, 21];
plot_SEIR(X_SEIR, X0_ad_SEIR, N, p_SEIR, dates, t0, tf, tp,"./results/october/Sardegna/SEIR_fitting.png");
%% FITTING SEIIR MODEL
...
close all 
tp = [7,14, 21];
plot_SEIIR(X_SEIIR, X0_ad_SEIIR, N, p_SEIIR, dates, t0, tf, tp, "./results/october/Sardegna/SEIIR_fitting.png");
...
close all
tp = [7,14, 21];
plot_SEIIRHD(X_SEIIRHD, X0_ad_SEIIRHD, N, p_SEIIRHD, dates, t0, tf, tp, "./results/october/Sardegna/SEIIRHD_fitting.png");
